...
import com.jeuxdevelopers.estatepie.databinding.FragmentTenantsViewAllBinding
...
@AndroidEntryPoint
class TenantsViewAllFragment : Fragment() {

    private lateinit var binding: FragmentTenantsViewAllBinding

    private val viewModel: TenantsViewAllViewModel by viewModels()
    ...
    override fun onCreateView(
        ...
        binding = FragmentTenantsViewAllBinding.inflate(inflater, container, false)
        return binding.root
    }
...
//                    it.result?.data.
    ...
    private fun initClickListeners() {
        ...
        binding.filterImage.setOnClickListener{
            ...
            findNavController().navigate(R.id.action_tenantsViewAllFragment_to_tenantsFilterFragment)
...
//            findNavController().navigate(R.id.action_tenantsViewAllFragment_to_tenantsAdsDetailFragment)
//        }
//        adapter.submitList(mutableListOf("1", "2", "3", "4", "5", "6", "7", "8"))
    ...
    private fun onRecommendedItemClicked(item : ViewAllRecomResponse.Data.Recommended){
        ...
        findNavController().navigate(R.id.action_tenantsViewAllFragment_to_tenantsAdsDetailFragment, bundle)
    ...
    private fun getDataToApplyFilter() {
        ...
        findNavController().currentBackStackEntry?.savedStateHandle?.getLiveData<String>(AppConsts.FILTER_DATA)?.observe(
