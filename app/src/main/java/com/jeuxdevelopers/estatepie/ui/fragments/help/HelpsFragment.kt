package com.jeuxdevelopers.estatepie.ui.fragments.help
...
import com.jeuxdevelopers.estatepie.databinding.FragmentHelpsBinding
...
class HelpsFragment : Fragment() {
    ...
    private val viewModel: HelpsViewModel by viewModels()

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View {
        binding = FragmentHelpsBinding.inflate(inflater, container, false)
