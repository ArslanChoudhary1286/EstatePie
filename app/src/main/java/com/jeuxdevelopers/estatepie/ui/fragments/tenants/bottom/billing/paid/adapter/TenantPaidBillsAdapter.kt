package com.jeuxdevelopers.estatepie.ui.fragments.tenants.bottom.billing.paid.adapter
...
class TenantPaidBillsAdapter(
    private val onItemClicked: (ListOfBillsResponse.Data.MaintenanceRequest) -> Unit,
) :
    ListAdapter<ListOfBillsResponse.Data.MaintenanceRequest, TenantPaidBillsAdapter.AdsGridViewHolder>(DiffCallback) {
