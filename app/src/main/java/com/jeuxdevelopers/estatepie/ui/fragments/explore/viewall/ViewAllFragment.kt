package com.jeuxdevelopers.estatepie.ui.fragments.explore.viewall
...
import com.jeuxdevelopers.estatepie.databinding.FragmentViewAllBinding
...
class ViewAllFragment : Fragment() {
    ...
    private fun initClickListeners() {
        ...
        binding.filterImage.setOnClickListener{
            ...
            navController!!.navigate(R.id.action_viewAllFragment_to_adsFilterFragment)
    ...
    private fun onRecommendedItemClicked(item : ViewAllRecomResponse.Data.Recommended){
        ...
        findNavController().navigate(R.id.action_viewAllFragment_to_adDetailFragment, bundle)
