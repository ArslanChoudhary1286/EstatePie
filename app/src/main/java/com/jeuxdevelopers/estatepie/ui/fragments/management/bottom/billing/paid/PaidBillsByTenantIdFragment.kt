...
import com.jeuxdevelopers.estatepie.databinding.FragmentPaidBillsByTenantIdBinding
...
@AndroidEntryPoint
class PaidBillsByTenantIdFragment : Fragment() {

    private lateinit var binding: FragmentPaidBillsByTenantIdBinding

    private val viewModel: PaidBillsByTenantIdViewModel by viewModels()

    var adapter = PaidBillsByTenantIdAdapter(::onItemClicked, ::onDeleteClick)

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View {
        binding = FragmentPaidBillsByTenantIdBinding.inflate(inflater, container, false)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel.getPaidBillsByTenantId()
    ...
    private fun initCollectors() {
        ...
        collectLatestLifecycleFlow(viewModel.paidBillsByTenantIdUiState){
            when(it){
...
//                    ToastUtility.errorToast(requireContext(), it.message)
    ...
    private fun setAdapter() {
        ...
        binding.recyclerPaidBillsByTenantId.adapter = adapter

    }

    private fun onItemClicked(item : PaidBillByTenantIdResponse.Data.Bill){

        val bundle = Bundle()
//        bundle.putString(AppConsts.PROFILE_ID, item.id.toString())
        bundle.putString(AppConsts.BILL_MODEL, Gson().toJson(item))
        findNavController().navigate(R.id.action_paidBillsByTenantIdFragment_to_billDetailFragment, bundle)


    }

    private fun onDeleteClick(bill: PaidBillByTenantIdResponse.Data.Bill) {
