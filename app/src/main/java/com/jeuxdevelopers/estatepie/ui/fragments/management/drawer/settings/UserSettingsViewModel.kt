...
class UserSettingsViewModel @Inject constructor(
    ...
    private val _userProfileState =
        MutableStateFlow<NetworkResult<UserProfileResponse>>(NetworkResult.Idle())
    ...
    fun getUserProfile(
        ...
        viewModelScope.launch {
            propertiesRepo.getUserProfile().collectLatest { _userProfileState.value = it }
        }
    }
            ...
            propertiesRepo.updateUserProfile(updateUserProfileRequest).collectLatest {
                ...
                if (it is NetworkResult.Success){
                    it.result?.data?.details.let { data ->
                        ...
                        loginResponse?.details?.business_name = data?.business_name!!
