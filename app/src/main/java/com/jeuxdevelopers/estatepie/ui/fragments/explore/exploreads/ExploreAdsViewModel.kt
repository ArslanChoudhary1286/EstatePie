...
@HiltViewModel
class ExploreAdsViewModel @Inject constructor(
    ...
    private val _exploreUiState = MutableStateFlow<NetworkResult<ExploreRecommendedResponse>>(NetworkResult.Idle())
    ...
    fun getRecommendedExploreList(
        ...
        viewModelScope.launch {
            exploreRepo.getExploreList(request).collectLatest { _exploreUiState.value = it }
        }
    }
