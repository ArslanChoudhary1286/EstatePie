...
import com.jeuxdevelopers.estatepie.databinding.FragmentIncidentTenantsDetailBinding
...
import com.jeuxdevelopers.estatepie.ui.fragments.tenants.bottom.dashboard.maintainrequest.adapter.ImagesMaintenanceAdapter
...
@AndroidEntryPoint
class IncidentTenantsDetailFragment : Fragment() {

    private lateinit var binding: FragmentIncidentTenantsDetailBinding

    private val viewModel: IncidentTenantsDetailViewModel by viewModels()

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View {
        binding = FragmentIncidentTenantsDetailBinding.inflate(inflater, container, false)
